...
save_dir = util.DATASET_NAME + "_" + "ANT" + "_" + time
...
parser.add_argument('--epochs_finetune', type=int, default=5, metavar='N', help='number of epochs for the refinement phase')
...
parser.add_argument('--epochs_finetune_node', type=int, default=5, metavar='N', help='number of epochs to perform global refinement at each node during the growth phase')
...
parser.add_argument('--classes', default=(0, 1, 2, 3, 4, 5, 6))
parser.add_argument('--no_classes', default=7)
