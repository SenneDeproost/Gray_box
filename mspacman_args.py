...
parser.add_argument('--output-dim', type=int, default=9, help='output dimension size (default: 10)')
parser.add_argument('--depth', type=int, default=7 , help='Depth of tree (default: 5)')
...
parser.add_argument('--augmentation_on', type=bool, default=True, help='Augmentation of dataset')